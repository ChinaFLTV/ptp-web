...
public class AssetController {
    ...
    public Result<Asset> queryAssetByUserId(
            @Parameter(name = "userId", description = "待查询的财产ID", in = ParameterIn.PATH)
            @PathVariable("userId")
            Long userId) {
    ...
    public Result<List<AssetVo>> queryPassagePage(@Parameter(name = "offset", description = "查询的一页财产数据的起始偏移量", in = ParameterIn.PATH) @PathVariable("offset") Long offset,
                                                  @Parameter(name = "limit", description = "查询的这一页财产数据的数量", in = ParameterIn.PATH) @PathVariable("limit") Long limit) {
    ...
    public Result<?> insertAsset(
            @Parameter(name = "asset", description = "待添加的财产信息")
            @RequestBody
            Asset asset) {
    ...
    public Result<?> updateAsset(
            @Parameter(name = "asset", description = "待修改的财产信息")
            @RequestBody
            Asset asset) {
    ...
    public Result<?> deleteAsset(
            @Parameter(name = "id", description = "待删除的财产信息ID", in = ParameterIn.PATH)
            @PathVariable("id")
            Long id) {
