...
# 2024-9-7  22:45-使mongodb执行一段一次性脚本(主要用于自动创建表)
# mongod --version
# mongosh -h
# sleep 10
# mongosh --host 172.250.250.91 --port 27017 --username "root" --password "ptp-backend-mongodb-pwd" --file "/data/script/create_table.js"
# mongosh --file "/data/script/create_table.js"
