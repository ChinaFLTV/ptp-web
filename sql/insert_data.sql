...
VALUES (1, 801, 'administrator',
        ...
        '[]'),
       (2, 802, 'manager', '["content_list","content_add","content_remove","user_add","user_remove"]',
        '["role_add","role_remove","role_list","role_update"]'),
       (3, 803, 'normal_user', '["content_list","content_add","content_update"]',
        '["user_add","user_remove","role_add","role_remove","role_list","role_update"]'),
       (4, 804, 'limit_user', '["content_list"]',
       ...
       (6, 806, 'publisher', '["content_list","content_add"]',
        '["user_add","user_remove","role_add","role_remove","role_list","role_update"]'),
       (7, 807, 'monitor', '["content_list","content_remove"]',
        '["user_add","user_remove","role_add","role_remove","role_list","role_update"]'),
       (8, 808, 'developer', '["user_add","user_remove"]',
        '["content_list","content_update","role_add","role_remove","role_list","role_update"]'),
       (9, 809, 'DevOps', '["role_add","role_remove","role_list","role_update"]',
        '["user_add","user_remove","content_add","content_update"]'),
       (10, 810, 'else', '["content_remove","content_update"]',
        '["user_add","user_remove","role_add","role_remove","role_list","role_update"]')
...
VALUES ('3599758685', '22851316', '13537484671',
        'l.shhieoo@gsv.at', '春物叙事曲', '易霞', '都是风景，幸会', '{
    "type": "url",
    ...
    "uri": "https://img.tukuppt.com/bg_grid/00/03/35/zcLyqiXIpY.jpg!/fh/350"
     ...
     , ('8939546763', '93719365', '18992484290',
        'dage3242742226@gmail.com', '树上有只熊', '乔洋', '我出售故事，谋杀，艳情 ，小道消息', '{
    "type": "url",
    ...
    "uri": "https://img.tukuppt.com/bg_grid/00/04/99/qel1H6beV0.jpg!/fh/350"
     ...
     , ('3521156476', '52802884', '18955647333',
        'q.rmjw@agep.sj', '银河投递员', '吕丽', '把自己流放到世界上的某个角落', '{
    "type": "url",
    ...
    "uri": "https://img.tukuppt.com/bg_grid/00/12/38/nYHRr2MgWc.jpg!/fh/350"
     ...
     , ('3528123755', '32553084', '18982578235',
        'z.amkn@hqzoo.al', '春天禁止入内', '高涛', '放松点，不用和每个人都好，也不用被每个人喜欢', '{
    "type": "url",
    ...
    "uri": "https://img.tukuppt.com/bg_grid/00/07/24/bG7xs5TbEb.jpg!/fh/350"
     ...
     , ('3590511491', '01583241', '18987740346', 'j.qkeq@xykngv.cl', '落日飛機', '方平',
        '一定要周而复始的快快乐乐', '{
    "type": "url",
...
VALUES (1, 3, 10, 5, NULL, 2, '这篇文章内容非常丰富，对我的工作帮助很大，谢谢作者的分享！', '["工作", "分享"]',
       ...
       (44, 3, 2, 9, NULL, 1, '这篇文章内容很有启发性，对我的学习产生了很大的帮助，期待作者更多的作品。',
        '["启发性", "帮助"]', '["学习", "分享"]', 7900, 4600, 700, 1250, 2600,
        '{"altitude": 94.5, "longitude": "121.473701", "latitude": "31.230416", "country": "中国", "countryID": "CN", "province": "上海市", "provinceID": "310000", "city": "上海市", "cityID": "310100", "county": "黄浦区", "countyID": "310101", "detailedLocation": "外滩"}'),
       (45, 24, 6, 5, NULL, 2, '这篇文章内容很有启发性，对我的学习产生了很大的帮助，谢谢作者的分享。', '["启发性", "帮助"]',
        '["学习", "分享"]', 7900, 4600, 700, 1250, 2600,
        '{"altitude": 94.5, "longitude": "121.473701", "latitude": "31.230416", "country": "中国", "countryID": "CN", "province": "上海市", "provinceID": "310000", "city": "上海市", "cityID": "310100", "county": "黄浦区", "countyID": "310101", "detailedLocation": "外滩"}'),
