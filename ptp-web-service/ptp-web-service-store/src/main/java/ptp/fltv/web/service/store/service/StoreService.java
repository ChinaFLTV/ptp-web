...
public interface StoreService {
     ...
     * @filename StoreService.java
     */
    boolean getFileInputStream(@Nullable String region, @Nonnull String bucketName, @Nonnull String fileName, @Nonnull String storePath, @Nullable Map<String, Object> option);
