...
import ptp.fltv.web.service.elasticsearch.ElasticSearchApplication;
...
public class SentinelDatasourceInitFunc implements InitFunc {
    ...
    public void init() {
        ...
        ReadableDataSource<String, List<FlowRule>> flowRuleDatasource = new NacosDataSource<>(SELF_HOST_IP + ":8848", "DEFAULT_GROUP", "ptp-web-service-elasticsearch-flow-rules",
        ...
        ReadableDataSource<String, List<DegradeRule>> degradationRuleDatasource = new NacosDataSource<>(SELF_HOST_IP + ":8848", "DEFAULT_GROUP", "ptp-web-service-elasticsearch-degradation-rules",
    ...
    private String confirmSelfHostIp() {
        ...
        String configIp = ElasticSearchApplication.context.getEnvironment().getProperty("ip.physical.self-host");
